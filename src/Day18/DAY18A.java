...
public class DAY18A {
    ...
    public static void main(String[] args){
        ...
        try{
            ...
            Queue<String> snailQueue = new LinkedList<String>();

            LinkedList<Node> currNum = new LinkedList<>();
            while(sc.hasNextLine()){
                String line = sc.nextLine();
                LinkedList<Node> num = createSnailNumber(line);
                if(currNum.isEmpty()){
                    currNum = num;
                }else{
                    currNum = addSnailNumbers(currNum, num);
                }
                currNum = reduceSnailNumber(currNum);
            }
